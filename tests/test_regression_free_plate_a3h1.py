...
def test_free_plate_a3h1_peak_counts() -> None:
    wav_path = Path("examples/free_plate_260122/media/audio/free_plate_A3H1.wav")
    ...
    _assert_peak_count(global_peaks, 775.2, 12)
