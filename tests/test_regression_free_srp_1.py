...
def test_free_srp_1_hits_and_primary_frequencies() -> None:
    """Sanity test on a known multi-hit file.

    Expectations based on the archived report under:
    `examples/free_SRP_260119/output/free_srp_1/`
    """

    wav_path = Path("examples/free_SRP_260119/media/audio/free srp 1.wav")
    ...
    expected_peaks = [150.732421875, 344.53125, 398.3642578125]
