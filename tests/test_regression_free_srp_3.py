...
def test_free_srp_3_hits_and_primary_frequency() -> None:
    """Sanity test on a known multi-hit file.

    Expectations based on the archived report under:
    `examples/free_SRP_260119/output/free_srp_3/`
    """

    wav_path = Path("examples/free_SRP_260119/media/audio/free srp 3.wav")
