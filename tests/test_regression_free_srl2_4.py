...
def test_free_srl2_4_hits_and_primary_frequency() -> None:
    """Sanity test on a known multi-hit file.

    Expectations based on the archived report under:
    `examples/free_SRL2_260119/output/free_srl2_4/`
    """

    wav_path = Path("examples/free_SRL2_260119/media/audio/free srl2 4.wav")
    ...
    assert rep.n_hits_found == 12
    assert rep.n_hits_used == 12
    ...
    expected_peaks = [301.46484375, 236.865234375, 150.732421875, 86.1328125]
